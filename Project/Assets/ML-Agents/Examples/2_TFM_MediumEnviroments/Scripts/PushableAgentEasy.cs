...
public class PushableAgentEasy : Agent {
    ...
    public override void OnEpisodeBegin()
    {
        ...
        this.transform.localPosition = new Vector3(-10, 0.8f, Random.Range(-10.0f, +10.0f));
        Object.localPosition = new Vector3(Random.Range(-3f, +3f), 4.0f, Random.Range(-10f, +10f));
        Object.localRotation = Quaternion.Euler(0, Random.Range(0f, +45.0f), 0);
        Target.localPosition = new Vector3(10f, 4.0f, Random.Range(-3.69f, +3.69f));
